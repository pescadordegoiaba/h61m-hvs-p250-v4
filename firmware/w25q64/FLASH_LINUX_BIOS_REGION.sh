...
DEFAULT_CHIP='W25Q64BV/W25Q64CV/W25Q64FV'
CHIP="${1:-$DEFAULT_CHIP}"
case "$CHIP" in
 'W25Q64BV/W25Q64CV/W25Q64FV'|'W25Q64JV-.Q') ;;
...
[4/6] FINAL BACKEND UNLOCK V4 PRONTO PARA GRAVAR.
Chip:       $CHIP
...
Digite exatamente: FLASH_FINAL_V4
EOX
read -r CONFIRM
[[ "$CONFIRM" == "FLASH_FINAL_V4" ]] || { echo "Cancelado."; exit 3; }
printf '
